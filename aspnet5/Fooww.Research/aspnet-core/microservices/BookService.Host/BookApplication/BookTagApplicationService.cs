...
namespace BookService.Host.Domain
{
    ...
    ///</summary>
    //[AbpAuthorize]
    public class BookTagAppService : BookAppServiceBase, IBookTagAppService
    {
        private readonly IRepository<BookTag, uint> _entityRepository;
        ...
        IRepository<BookTag, uint> entityRepository
        ...
        /// </summary>
        //[AbpAuthorize(BookTagPermissions.Query)]
        public async Task<BookTagListDto> GetById(EntityDto<uint> input)
        {
        ...
        public async Task<GetBookTagForEditOutput> GetForEdit(NullableIdDto<uint> input)
        {
