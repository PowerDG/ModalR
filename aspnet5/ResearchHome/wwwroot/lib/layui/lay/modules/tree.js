...
; layui.define("jquery", function (e) {
    ...
    r.prototype.init = function (e, treeMaxHeight, isSpread) {
        var o = this;
        this.isSpread = isSpread;
        e.addClass("layui-box layui-tree"), o.options.skin && e.addClass("layui-tree-skin-" + o.options.skin), o.tree(e), o.on(e);
        if (treeMaxHeight !== undefined) $('.layui-anim-upbit').css("max-height", treeMaxHeight + "px");
        $('.layui-anim-upbit>dd').css("background-color", "#fff");
    }, r.prototype.tree = function (e, a) {
        var i = this,
            r = i.options,
            n = a || r.nodes;
        layui.each(n, function (a, n) {
            n.spread = i.isSpread || n.spread;
            var l = n.children && n.children.length > 0,
                ...
                s = o(["<li " + (n.spread ? 'data-spread="' + n.spread + '"' : "") + ">", function () {
                    ...
                    return r.check ? '<i class="layui-icon layui-tree-check">' + ("checkbox" === r.check ? t.checkbox[0] : "radio" === r.check ? t.radio[0] : "") + "</i>" : ""
                        ...
                        return '<a style="padding-left:' + (n.level !== 3 ? '0px;' : '10px;') + 'cursor:' + (n.level !== 3 ? 'pointer;' : 'not-allowed;')
                            + 'color:' + (n.level !== 3 ? '"' : 'gray"') + 'href="' + (n.href || "javascript:;") + '" '
                        + (r.target && n.href ? 'target="' + r.target + '"' : "") + ">" + ("<cite>" + (n.name || "未命名") + "</cite></a>")
                }(), "</li>"].join(""));
    ...
    }, e("tree", function (e, treeMaxHeight, isSpread) {
        var i = new r(e = e || {}),
            t = o(e.elem);
        return t[0] ? void i.init(t, treeMaxHeight, isSpread) : a.error("layui.tree 没有找到" + e.elem + "元素")
    })
});