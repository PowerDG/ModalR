...
layui.define('jquery', function(exports){
    ...
    ,util = {
      ...
      fixbar: function(options){
        ...
        options.bar3 = options.bar3 === true ? '&#xe607;' : options.bar3;
        options.bgcolor = options.bgcolor ? ('background-color:' + options.bgcolor) : '';
        
        var icon = [options.bar1, options.bar2, options.bar3, '&#xe604;'] //图标：信息、问号、TOP
        ,elem = $(['<ul class="'+ ELEM +'">'
          ...
          ,options.bar3 ? '<li class="layui-icon" lay-type="bar3" style="'+ options.bgcolor +'">'+ icon[2] +'</li>' : ''
          ,'<li class="layui-icon '+ TOP_BAR +'" lay-type="top" style="'+ options.bgcolor +'">'+ icon[3] +'</li>'
        ,'</ul>'].join(''))
